...
You can configure youtube-dl by placing any supported command line option to a configuration file. The table below shows the locations of the config files.

|              | System wide config file location | User wide config file location |
|--------------|----------------------------------|--------------------------------|
| Linux/ macOS | /etc/youtube-dl.conf             | ~/.config/youtube-dl/config    |
| Windows      | %APPDATA%\youtube-dl\config.txt  | C:\Users\&lt;user              |
